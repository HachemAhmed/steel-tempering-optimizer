...
if __name__ == "__main__":
    ...
    # Criar uma pasta 'outputs' para salvar as imagens
    output_dir = os.path.join(root_dir, 'outputs')
    os.makedirs(output_dir, exist_ok=True)
    
    # Definir caminhos de saída para as imagens
    ...
    if meu_grafo_de_acos.graph:
        ...
        # (MUDANÇA) Mudar nome da variável
        ...
        # (MUDANÇA) Imprimir os detalhes de forma limpa
        if detalhes_1:
